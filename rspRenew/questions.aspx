<%@ Page Title="" Language="C#" MasterPageFile="~/rspRenew.Master" AutoEventWireup="True" CodeBehind="questions.aspx.cs" Inherits="rspRenew.questions" %>
...
<table cellpadding="3" cellspacing="0" border="0" width="600">
	...
	<tr>
		<td>5.  Since your last registration or submission of your license application, not including investigations or disciplinary actions by TMB, are there pending investigations, pending disciplinary matters or final disciplinary actions against you by any licensing agency or health-care entity? (If yes, a follow up letter will be sent to you at your listed mailing address after all applications have been processed.) <span class ="required">*</span> </td>
	</tr>
	<tr>
		<td >
    ...
    <%--		
	<tr>
		<td>6.  Since your last registration or submission of your license application, have you been diagnosed, treated, or admitted to a hospital or other facility for any of the following: Major depressive disorder, bipolar disorder, schizophrenia, schizoaffective disorder, or any severe personality disorder? (If yes, a follow up letter will be sent to you at your listed mailing address after all applications have been processed.) <span class ="required">*</span> </td>
	</tr>
	<tr>
		<td >
		...
		<tr>
			<td>8.  Since your last registration or submission of your license application, have you been diagnosed, treated, or admitted to a hospital or other facility for a physical or neurological impairment? (If yes, a follow up letter  will be sent to you at your listed mailing address after all applications have been processed.) <span class ="required">*</span> </td>
		</tr>
		<tr>
			<td>
...
<a href ="http://www.txphp.state.tx.us/" target="_blank">http://www.txphp.state.tx.us/</a>, under the “Forms” section of the website.
        ...
        <tr>
		<td>11. I certify that since my last registration, I have met current continuing education (CE)requirements for Respiratory Care Practitioners.<span class ="required">*</span>
        </td>
		</tr>
		<tr>
			<td>
