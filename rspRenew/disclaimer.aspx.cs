...
namespace rspRenew
{
    public partial class disclaimer : System.Web.UI.Page
    {
        ...
        protected void continueBTN_Click(object sender, EventArgs e)
        {
            ...
            //public static phyAppCL.phyApp getApplDBwip(string ln_fn_dob, string type_of_app)
            ...
            try
            {
                ...
                //no.PreparePayment("https://stageccp.dev.cdc.nicusa.com/CommonCheckout/CCPWebService/ServiceWeb.svc", getRevCodes, getUsas);
                //
            }
            catch (Exception err)
            {
