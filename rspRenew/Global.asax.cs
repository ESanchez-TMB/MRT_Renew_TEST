    ...
    public class Global : System.Web.HttpApplication
    {
        ...
        void Application_Start(object sender, EventArgs e)
        {
           ...
           {"Armed Forces Pacific", "AP"}};
            ...
            Application["ach"] = ach;
            // create and store the AMS_LegacyOnline object
            try
            {
                ...
                Application["AMS"] = m_oAMS_LegacyOnlineInterface;
                App_Code.DataAccess.log("AMS object created in Asax", "rspRenew.Asax");
            }
            catch (Exception exc)
            {
                App_Code.DataAccess.log("Error, could not create AMS_LegacyOnlineInterface: " + exc.Message, "rspRenew.Asax");                
            }
