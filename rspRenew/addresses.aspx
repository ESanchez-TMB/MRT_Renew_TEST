<%@ Page Title="" Language="C#" MasterPageFile="~/rspRenew.Master" AutoEventWireup="True" CodeBehind="addresses.aspx.cs" Inherits="rspRenew.addresses" %>
...
<p>Asterisk (<span class ="required">*</span>) indicates response required.</p>
	...
	<table class="tdData" cellpadding="3" cellspacing="0" border="0" width="100%">
       ...
       <%-- <tr><td>Email:</td><td><asp:TextBox ID="emailTB" runat ="server" ></asp:TextBox></td></tr>--%>
		...
		<tr class="hideRow"><td class="style1">Phone: (999-999-9999)</td><td class="style1"><asp:TextBox ID="pPhoneTB" runat ="server" ></asp:TextBox></td></tr>
