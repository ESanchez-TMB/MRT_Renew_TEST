...
namespace rspRenew
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //
            //createXXX();  // not necesary because chuck's routine works first time now 4-9-18
            //   
        }
        ...
        protected void continue_Click(object sender, EventArgs e)
        {
            ...
            //: chuck's routine will go here
             
            //bool success = createXXX();  //create chuck routine  
            m_oAMS_LegacyOnlineInterface = (AMS_LegacyOnlineInterface)Application["AMS"];
            ...
            {
                App_Code.DataAccess .log("Error chuck: " + exc.Message, "rspRenew.Login continue_Click()");
                r = null;
            }
        ...
        //    catch (Exception exc)
        //    {
        //        App_Code.DataAccess.log("Error, could not create AMS_LegacyOnlineInterface: " + exc.Message, "rspRenew.Login");
        //        return false;
        //    }
        //}
