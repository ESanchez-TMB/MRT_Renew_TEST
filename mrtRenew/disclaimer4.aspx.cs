    ...
    public partial class disclaimer4 : System.Web.UI.Page
    {
        ...
        protected void populateControls()
        {
            ...
            if (r.methodOfPayment == "CC")  // if ((ach == 0.0m) || (r.methodOfPayment == "CC"))   9_1_18
            {
                ...
                //cfee = App_Code.Utilities.getCfee(r.CURRFEE + r.lateFee);  //10_10_16 commented out on 2024_10_15
               cfee = App_Code.Utilities.getCfee(r.CURRFEE + r.lateFee + R4403.Total_fee);  //2024_10_15 should be
            }
            else
            {
        ...
        protected void continueBTN_Click(object sender, EventArgs e)
        {
            ...
            no.localrefid = RClassLibrary.utilities .genTraceNum ("503MW", order.order_id);
            //
            ...
            if (answer != "success")
            {
                RClassLibrary.DataAccess.log("MRT Error could not write to final: " + answer, "MRT renew disclaimer4.aspx.cs");
            ...
            if (answer != "success")
            { RClassLibrary.DataAccess.log("Error could not write to final: " + answer, "MRT renew disclaimer4.aspx.cs"); }
            ...
            if ((no.ppr.TOKEN != "0") && (no.ppr.TOKEN != null))
            {
                ...
                trace_license.Add(r.trace_number, r.LicNum);
                //evidently you do not need to store dictionary - not thread safe on write - is there a problem - we will see.
                //fdms
                // eric's code 
                try
                {
                ...
                {
                    App_Code.DataAccess.log("Error MRT: " + exc.Message, "mrt.disclaimer4.continueBTN_Click");
                    //do nothing
                }
                //
            ...
            {
                App_Code.DataAccess.log("Error MRT: from NIC preparepay: " + no.ppr.ERRORMESSAGE, "disclaimer4.aspx");
