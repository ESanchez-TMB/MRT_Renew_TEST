<%@ Page Title="" Language="C#" MasterPageFile="~/mrtRenew.Master" AutoEventWireup="true" CodeBehind="review.aspx.cs" Inherits="mrtRenew.review" %>
...
<table class="blackBorder"  width ="400" style="border-collapse:collapse;" >
		...
		<tr>
		<td class="style1">Mailing Address 2:</td>
		<td class="style1"><asp:Label ID ="madd2LBL" runat ="server" Columns ="30" MaxLength ="30"></asp:Label></td>
		</tr>
		<tr>
		...
		<tr>
		<td class="style2">Mailing Zip Code<span class="required">*</span>:</td>
		<td class="style2"><asp:Label ID ="mZipLBL" runat ="server" ></asp:Label></td>
		</tr>
        <tr>
...
<tr>
			<td>6. Are you currently suffering from any condition for which you are not being appropriately treated that impairs your judgment or that would otherwise adversely affect your ability to practice medicine in a competent, ethical and professional manner?  <span class = "required">*</span>
            <b><asp:Label ID="impairmentLBL" runat ="server" ></asp:Label></b></td>
        </tr>
...
<tr>
<td>11.  I certify that since my last registration, I have met current continuing education (CE) requirements for Medical Radiologic Technologists or Limited Medical Radiologic Technologists, as appropriate.<span class="required">*</span><br />
